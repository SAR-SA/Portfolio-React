  ...
  return (
    ...
    <div className="container-fluid">
      <div className="link-btns row">
        <a className="gitBtn fab fa-github fa-4x ml-5 mr-5" href="https://github.com/SAR-SA"></a>
        <a className="liBtn fab fa-linkedin-in fa-4x ml-5 mr-5"
          href="https://www.linkedin.com/in/shawn-a-rather-9a37ba56/"></a>
        <a className="emBtn far fa-envelope fa-4x ml-5 mr-5" href="mailto:SARSA.web@gmail.com"></a>
        <a className="emBtn far fa-file-pdf fa-4x ml-5 mr-5" href="assets/Shawn A. Rather Resume.pdf"></a>
      </div>
